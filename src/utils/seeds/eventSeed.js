const springEvents = [
  {
      ...
      category: 'Mix',
      image: "https://www.tiempo.es/build/img/specials/festivales-de-musica/primaverasound/logo.jpg"
  },
  {
    name: 'Mad Cool',
    date: '2026-01-21',
    ...
    category: 'Metal',
    image: "https://img.europapress.es/fotoweb/fotonoticia_20180710075003_1920.jpg",
  },
  {
    ...
    category: 'Rock',
    image: "https://www.dodmagazine.es/wp-content/uploads/2011/07/bbk-live-2012.jpg",
  },
  {
  ...
  },
  {
    ...
    category: 'Rock',
    image: 'https://c.ststat.net/content/entimg/tour/ecd4f1f7-a5e6-4894-bb97-6d36cdaed8fa.jpg',
  },
  {
    name: 'Arenal Sound',
    date: '2026-10-01',
    ...
    category: 'Indie',
    image: 'http://guiamove.com/wp-content/uploads/2018/06/as_logo.gif',
  },
  {
    name: 'Low Festival',
    date: '2026-12-26',
    ...
    price: 70,
    description:
      'El Low Festival es un festival de música independiente que se celebra en Benidorm, España. Presenta una selección de artistas de rock, indie, pop y electrónica tanto nacionales como internacionales.',
    category: 'Mix',
    image: 'https://lowfestival.es/wp-content/uploads/2023/09/Logo-Azul_LOW24-1-1024x889.png',
  },
  {
    ...
    price: 35,
    description:
      'El Download Festival Madrid es un festival de música que forma parte de la franquicia internacional Download Festival. Se celebra en Madrid, España, y presenta una selección de artistas de heavy metal, rock y punk.',
    category: 'Rock',
    image: "https://consequence.net/wp-content/uploads/2023/11/Download-Fest-UK-2024.jpeg?quality=80"   }
];

module.exports = springEvents;